...
Int_line_plt <- ggplot(time_sum_int, aes(Year)) +
  ...
  geom_line(aes(y = vol/2000), colour = "darkred", alpha = .5, linetype = "dashed", size = 1) +
...
Thr_line_plt <- ggplot(time_sum_thr, aes(Year)) +
  ...
  geom_line(aes(y = vol/2000), colour = "darkorange", alpha = .5, linetype = "dashed", size = 1) +
  scale_y_continuous(name = "Richness", 
                     sec.axis = sec_axis(~.*2000, name="Volume")) +
...
DD_line_plt <- ggplot(time_sum_NE, aes(Year)) +
  ...
  geom_line(aes(y = vol/2000), colour = "darkblue", alpha = .5, linetype = "dashed", size = 1) +
  scale_y_continuous(name = "Richness", 
                     sec.axis = sec_axis(~.*2000, name="Volume")) +
  theme_minimal()
...
coverage_plt_alt2 <- coverage_plt_alt + 
  annotation_custom(text_grob("Historical (1997 - 2015)", face = "bold", size= 14, hjust = 0), 
                    xmin = 0.37, xmax = 0.37, ymin = 0.97, ymax = 0.97) +
  annotation_custom(text_grob("Recent (2016 - 2021)", hjust = 0,face = "bold", size= 14), 
                    xmin = 0.68, xmax = 0.68, ymin = 0.97, ymax = 0.97) +
  annotation_custom(text_grob("80 exporters, 248 taxa", hjust = 0,face = "italic", size= 10), 
                    xmin = 0.37, xmax = 0.37, ymin = 0.67, ymax = 0.67) +
  annotation_custom(text_grob("19 exporters, 27 taxa", hjust = 0,face = "italic", size= 10), 
                    xmin = 0.68, xmax = 0.68, ymin = 0.67, ymax = 0.67) +
  annotation_custom(text_grob("64 exporters, 54 taxa", hjust = 0,face = "italic", size= 10), 
                    xmin = 0.37, xmax = 0.37, ymin = 0.34, ymax = 0.34) +
  annotation_custom(text_grob("28 exporters, 27 taxa", hjust = 0,face = "italic", size= 10), 
                    xmin = 0.68, xmax = 0.68, ymin = 0.34, ymax = 0.34) +
  annotation_custom(text_grob("41 exporters, 43 taxa", hjust = 0,face = "italic", size= 10), 
                    xmin = 0.37, xmax = 0.37, ymin = 0.01, ymax = 0.01) +
  annotation_custom(text_grob("8 exporters, 11 taxa", hjust = 0,face = "italic", size= 10), 
                    xmin = 0.68, xmax = 0.68, ymin = 0.01, ymax = 0.01)

ggsave(path = "Outputs/Figures", coverage_plt_alt2, filename = "coverage_alt_R1.png",  bg = "white",
       device = "png", width = 26, height = 12, units = "cm")
